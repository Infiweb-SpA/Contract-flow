...
class Contract(db.Model):
    ...
    creation_type = db.Column(db.String(50), default='CREADO')  # CREGADO o IMPORTADO_OCR
    ...
    status = db.Column(db.String(30), default='BORRADOR')  # BORRADOR, VIGENTE, FINALIZADO
    created_at = db.Column(db.DateTime, default=datetime.utcnow)

    # Relaciones sincronizadas con back_populates
